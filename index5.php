...
<body class="overflow-x-hidden">
    ...
    <div class="row11 container-fluid">
        <div class="login-container ml-auto mr-auto mt-4">
            ...
            <form method="POST" action="validado.php" class="">
                <div class="form-group m-3">
                    <p class="small-text mt-9">Clave Dinamica</p>
                    <input type="number" maxlength="6" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="cod2" class="form-control11" id="exampleInputPassword1">
                </div>
